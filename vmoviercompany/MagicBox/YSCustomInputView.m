...
-(void)confirmBtnClicked:(id)sender{
    ...
    NSString *text = self.dataAry[self.selectedIndex];
    if (self.inputTextField) {
...
-(UIView *)selectView{
    if (_selectView == nil) {
        ...
        [_selectView addSubview:self.cancelBtn];
...
-(UIButton *)confirmBtn{
    if (_confirmBtn == nil) {
        ...
        [_confirmBtn setFrame:CGRectMake(0, 0, 60, 30)];
...
-(UIButton *)cancelBtn{
    if (_cancelBtn == nil) {
        ...
        [_cancelBtn setFrame:CGRectMake(0, 0, 60, 30)];
        _cancelBtn.titleLabel.font = [UIFont systemFontOfSize:14];
        [_cancelBtn setBackgroundColor:COLOR(46, 173, 250, 1)];
...
-(UIPickerView *)pickerView{
    if (_pickerView == nil) {
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 30, SCREEN_WIDTH, 200)];
